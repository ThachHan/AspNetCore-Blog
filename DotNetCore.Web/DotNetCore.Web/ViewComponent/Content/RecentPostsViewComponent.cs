...
namespace DotNetCore.Web
{
    ...
    public class RecentPostsViewComponent : ViewComponent
    {
        ...
        public RecentPostsViewComponent(IContentService contentService, IMapper mapper, IAuthorService authorService,
        ...
        {
            var contents = _contentService.GetRecentsContent().Take(4);
